...
function getRandomNumber() {
    ...
    if (isAllFilled) {
        ...
        if (nbMin >= nbMax) {
            div_alea_nombre_result.textContent = 'Le nombre minimum doit être inférieur au nombre maximum';
        }
        ...
        for (let i = 0; i < nbNombres; i++) {
            ...
            if (isAvecRemise) {
                ...
                nombre = (Math.random() * (nbMax - nbMin) + nbMin).toFixed(2);
            }
            else {
